...
import { Tags } from "../AlphaFilters/Tags";
...
import { AppliedFilterInterface, FilterGroupInterface, FilterInterface, FilterPrimaryAction } from "./types";
...
export interface FiltersProps {
  ...
  onQueryBlur?(): void;
  /** Hành động khi khi ấn button xoá bộ lọc trong bộ lọc mở rộng*/
  onClearAll(): void;
